# Cover Letter — Statistical Journal of the IAOS
...
We submit for your consideration a manuscript entitled "Known Censoring, Not Missingness: Cell Suppression and Partial Identification in Open Administrative Healthcare Data," which we believe is well suited to the *Statistical Journal of the IAOS*.
...
**Declarations.** This study used only publicly available aggregate data; ethics review was not required. No competing interests exist. No funding was received for this work. The manuscript has not been submitted elsewhere and is not under concurrent review.

We welcome the opportunity to address any concerns raised by reviewers and appreciate your consideration.
